...
try:
    # Retrieve NGSI-LD Entity of type TemperatureSensor by its id: GET /entities/{entityId}
    api_response = api_instance.retrieve_entity(entity_id='urn:ngsi-ld:TemperatureSensor:1')
...
try:
    # Retrieve NGSI-LD Entity of type HumiditySensor by its id: GET /entities/{entityId}
    api_response = api_instance.retrieve_entity(entity_id='urn:ngsi-ld:HumiditySensor:1')
    logger.info(api_response.to_dict())
except Exception as e:
    logger.exception("Exception when calling ContextInformationConsumptionApi->retrieve_entity: %s\n" % e)

try:
    # Retrieve NGSI-LD Entity of type IotDevice by its id: GET /entities/{entityId}
