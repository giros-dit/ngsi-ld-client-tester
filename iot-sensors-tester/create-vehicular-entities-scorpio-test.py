...
#print(parking_location.to_dict())
...
#print(geoproperty_location.to_dict())

'''
geoproperty_location = GeoProperty.from_dict({
    "type": "GeoProperty",
    "value": parking_location.to_json()
}
)
print(geoproperty_location.to_dict())
'''
...
isParked = IsParked(
    ...
    #entity= parking.to_dict(), #RelationshipEntity.from_dict(Entity.from_dict(parking.to_dict()).to_dict()),
    observedAt=observed_at,
    providedBy=ProvidedBy.from_dict({"type": "Relationship", "object": "urn:ngsi-ld:Person:Bob"}),
)

#passengers_input = []
#passengers_input.append(Entity.from_dict(person_alice.to_dict()))
#passengers_input.append(Entity.from_dict(person_bob.to_dict()))

passengers = Passengers(
    type="Relationship",
    object=["urn:ngsi-ld:Person:Alice", "urn:ngsi-ld:Person:Bob"],
    objectType="Person",
    #entity=person_alice.dict()
    #entity=[person_alice.to_dict(), person_bob.to_dict()]
    #entity=[{"id": "urn:ngsi-ld:Person:Alice", "type": "Person"}, {"id": "urn:ngsi-ld:Person:Bob", "type": "Person"}],
)
...
route = Route(
    ...
    objectType="City",
    #entityList=[city_antwerp.to_dict(), city_rotterdam.to_dict(), city_amsterdam.to_dict()]
    #entityList=[{"id": "urn:ngsi-ld:City:Antwerp", "type": "City"}, {"id": "urn:ngsi-ld:City:Rotterdam", "type": "City"}, {"id": "urn:ngsi-ld:City:Amsterdam", "type": "City"}],
)
