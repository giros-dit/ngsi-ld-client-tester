...
try:
    ...
    api_response = api_instance.query_entity(type='HumiditySensor')
    humiidity_sensor_entities = api_response
    for humiidity_sensor_entity in humiidity_sensor_entities:
        logger.info(humiidity_sensor_entity.to_dict())
