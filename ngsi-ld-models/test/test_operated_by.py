...
class TestOperatedBy(unittest.TestCase):
    """OperatedBy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OperatedBy:
        """Test OperatedBy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OperatedBy`
        """
        model = OperatedBy()
        if include_optional:
            return OperatedBy(
