...
class TestTyreTreadDepths(unittest.TestCase):
    """TyreTreadDepths unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TyreTreadDepths:
        """Test TyreTreadDepths
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TyreTreadDepths`
        """
        model = TyreTreadDepths()
        if include_optional:
