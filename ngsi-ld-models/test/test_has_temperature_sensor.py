...
class TestHasTemperatureSensor(unittest.TestCase):
    """HasTemperatureSensor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HasTemperatureSensor:
        """Test HasTemperatureSensor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HasTemperatureSensor`
        """
        model = HasTemperatureSensor()
        if include_optional:
    ...
    def testHasTemperatureSensor(self):
        """Test HasTemperatureSensor"""
