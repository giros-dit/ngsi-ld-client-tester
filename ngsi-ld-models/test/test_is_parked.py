...
class TestIsParked(unittest.TestCase):
    """IsParked unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IsParked:
        """Test IsParked
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IsParked`
        """
        model = IsParked()
        if include_optional:
            return IsParked(
