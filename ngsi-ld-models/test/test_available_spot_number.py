...
class TestAvailableSpotNumber(unittest.TestCase):
    """AvailableSpotNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AvailableSpotNumber:
        """Test AvailableSpotNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AvailableSpotNumber`
        """
        model = AvailableSpotNumber()
        if include_optional:
    ...
    def testAvailableSpotNumber(self):
        """Test AvailableSpotNumber"""
