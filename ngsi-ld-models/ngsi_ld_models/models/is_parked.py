...
class IsParked(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "object", "objectType", "observedAt", "datasetId", "createdAt", "modifiedAt", "deletedAt", "instanceId", "previousObject", "entity", "providedBy"]
