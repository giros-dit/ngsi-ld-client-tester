...
class AvailableSpotNumber(BaseModel):
    """
    ...
    provided_by: Optional[ProvidedBy] = Field(default=None, alias="providedBy")
    __properties: ClassVar[List[str]] = ["type", "value", "observedAt", "unitCode", "datasetId", "createdAt", "modifiedAt", "deletedAt", "instanceId", "previousValue", "reliability", "providedBy"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of reliability
        if self.reliability:
            _dict['reliability'] = self.reliability.to_dict()
        # override the default output from pydantic by calling `to_dict()` of provided_by
        if self.provided_by:
            _dict['providedBy'] = self.provided_by.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reliability": Reliability.from_dict(obj["reliability"]) if obj.get("reliability") is not None else None,
            "providedBy": ProvidedBy.from_dict(obj["providedBy"]) if obj.get("providedBy") is not None else None
        })
        return _obj
