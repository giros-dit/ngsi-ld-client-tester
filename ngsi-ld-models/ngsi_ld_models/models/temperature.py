...
class Temperature(BaseModel):
    ...
    temperature_description: Optional[TemperatureDescription] = Field(default=None, alias="temperatureDescription")
    temperature_coordinates: Optional[TemperatureCoordinates] = Field(default=None, alias="temperatureCoordinates")
    __properties: ClassVar[List[str]] = ["type", "value", "observedAt", "unitCode", "datasetId", "createdAt", "modifiedAt", "deletedAt", "instanceId", "previousValue", "temperatureDescription", "temperatureCoordinates"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of temperature_description
        if self.temperature_description:
            _dict['temperatureDescription'] = self.temperature_description.to_dict()
        # override the default output from pydantic by calling `to_dict()` of temperature_coordinates
        if self.temperature_coordinates:
            _dict['temperatureCoordinates'] = self.temperature_coordinates.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "temperatureDescription": TemperatureDescription.from_dict(obj["temperatureDescription"]) if obj.get("temperatureDescription") is not None else None,
            "temperatureCoordinates": TemperatureCoordinates.from_dict(obj["temperatureCoordinates"]) if obj.get("temperatureCoordinates") is not None else None
        })
        return _obj
