...
class Temperature(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Temperature:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Temperature:
        """Create an instance of Temperature from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Temperature.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in Temperature) in the input: " + obj)

        _obj = Temperature.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value"),
