...
class Humidity(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Humidity:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Humidity:
        """Create an instance of Humidity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Humidity.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in Humidity) in the input: " + obj)

        _obj = Humidity.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value"),
