...
class TemperatureAllOf(BaseModel):
    """
    TemperatureAllOf
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TemperatureAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TemperatureAllOf:
        """Create an instance of TemperatureAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TemperatureAllOf.parse_obj(obj)

        _obj = TemperatureAllOf.parse_obj({
            "value": obj.get("value")
        })
